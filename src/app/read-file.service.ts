...
export class ReadFileService {
  ...
  private uploadFileToGitHubs(fileName: string, file: Blob, directoryPath: string): void {
    const apiUrl = `https://api.github.com/repos/849357biswajeet/mynewcalculator/contents/mycontents/${fileName}.xlsx`;
    const headers = {
 ...
 reader.readAsDataURL(file);
  ...
  getXlsxFilesInFolder(): Observable<string[]> {
    const apiUrl = `https://api.github.com/repos/849357biswajeet/mynewcalculator/contents/mycontents`;
  ...
  downloadFileFromGithub(filePath: string): Observable<ArrayBuffer> {
    const apiUrl = `https://api.github.com/repos/849357biswajeet/mynewcalculator/contents/mycontents/${filePath}`;
